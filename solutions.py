...
def is_sweltering():
    ...
    current_temp = input("How many degrees is it right now in Farenheit? ")
...
def is_humid():
    ...
    """
    # write your code for this function below this line.
    humidity = input("Is it humid right now? ").lower()
    if humidity == "yes":
        return True
    else:
        return False
...
def is_inclement():
    ...
    """
    # write your code for this function below this line.
    forecast = input("What's the weather forecast for today? ").lower()
